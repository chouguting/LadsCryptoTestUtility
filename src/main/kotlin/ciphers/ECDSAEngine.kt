...
fun main() {
    val curveName = "P-256"
    val qx =
        "765AFA3EEEE046FD5BDA99F7DE707D313C04F29E15579A50C18E193F527EDA87"  //The public key curve point x
    val qy =
        "00A80C57E3E3A416750D5CB936AE3F1BFC75BB4263620DDA272DD3FB26AD4E6507"  //The public key curve point y
//    println(ECDSAEngine(curveName).validateECDSAKey(qx, qy))

    val message = ""
    val r = "A8C74036A5F10CD4F654F7152902052573D2FA18968992CD5F9A841041C2D226"
    val s = "E4C895C88150DB078761EEA75DE3BC0C93FBA20120B66FA53B701C20BB9C0D15"
    val ecdsaEngine = ECDSAEngine(curveName)
    println(ecdsaEngine.verifySignature(message, "SHA-256", qx, qy, r, s))
